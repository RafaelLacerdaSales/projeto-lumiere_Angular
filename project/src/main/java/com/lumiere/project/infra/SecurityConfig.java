    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        // PERMISSÃO ADICIONADA: Permite acesso a todos os arquivos estáticos (imagens) em /images/**
                        // Isso é fundamental para o front-end carregar as capas dos cursos.
                        ...
                        // CORREÇÃO: O endpoint DELETE do WorkshopController é "/delete/{id}"
                        .requestMatchers(HttpMethod.DELETE, "/workshop/delete/{id}").permitAll() 
